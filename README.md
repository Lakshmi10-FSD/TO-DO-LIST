...
🔍 Real-time search and filtering options<br>
📅 Task scheduling with date & time tracking<br>
⏰ Automatic overdue alerts for missed deadlines<br>
📊 Live progress tracking with dynamic progress bar<br>
📌 Task categorization with priority levels (High, Medium, Low)<br>
🌙 Dark mode for better user experience<br>
💾 Persistent data storage using Local Storage<br>
✔️ One-click mark all tasks as completed<br>
🧹 Remove completed tasks instantly<br>
